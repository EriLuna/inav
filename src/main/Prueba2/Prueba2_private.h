...
#ifndef RTW_HEADER_Prueba2_private_h_
#define RTW_HEADER_Prueba2_private_h_
#include "rtwtypes.h"
...
extern void Prueba2_derivatives(void);

#endif                                 /* RTW_HEADER_Prueba2_private_h_ */
